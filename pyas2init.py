...
def initialize():
    ...
    if not gsettings:
        ...
        gsettings['cert_path'] = pyas2_settings.get('CERT_PATH')
        ...
        gsettings['log_file'] = pyas2_settings.get('LOGFILE',False)
        gsettings['log_file_level'] = pyas2_settings.get('LOGFILELEVEL',None)
        gsettings['log_console'] = pyas2_settings.get('LOGCONSOLE',True)
        gsettings['log_console_level'] = pyas2_settings.get('LOGCONSOLELEVEL',None)
...
def initserverlogging(logname):
    ...
    if gsettings['log_file']:
        logger.setLevel(convertini2logger[gsettings['log_file_level'] or gsettings['log_level']])
    ...
    if gsettings['log_console']:
        ...
        console.setLevel(convertini2logger[gsettings['log_console_level'] or gsettings['log_level']])
